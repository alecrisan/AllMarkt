...
{
    public class ProductWithRatingViewModelTests
    {
        [Theory]
        ...
        private static IEnumerable<object> GetViewModels(string name, string description = "description", double price = 0, string imageURI = null, bool state = true, int productCategoryId = 1, double averageRating = 0.00)
        {
            yield return new ProductWithRatingViewModel
            {
                Name = name,
